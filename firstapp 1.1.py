...
canvas = tk.Canvas(root,height = 500, width=400, bg="red")
canvas.pack()

bold_font = tkfont.Font(family="Helvetica",size=12,weight="bold")

label1 = tk.Label(root,text= "Type in your message ",width=20,bg="red")
...
label2=tk.Label(root,text="Choose an Operation",width=25,bg="red")
...
label3=tk.Radiobutton(root, text="Encrypt",padx = 20, variable=v, value=1,command=choice,bg="light yellow")
label3.config(font=bold_font)
canvas.create_window(100,250,window=label3)
label4=tk.Radiobutton(root, text="Decrypt",padx = 20, variable=v, value=2,command=choice,bg="light yellow")
...
label7 =tk.Label(root,text="Transfigured Text ",width=20,bg="red")
